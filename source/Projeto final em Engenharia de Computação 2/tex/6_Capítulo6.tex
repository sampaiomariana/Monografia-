...
Nesta seção é apresentada a arquitetura do software segundo uma visão\emph{(view)} e a mesma é representada segundo um ponto de vista \emph{(viewpoint)}. O sistema de software é inicialmente decomposto em componentes, considerando as responsabilidades do mesmo. Nessa arquitetura, tem-se que usando um navegador, o usuário, seja ele cidadão ou gestor do posto, pode acessar os serviços providos para o usuário acessando a interface da aplicação. Ao ter acesso, tem-se o acesso para usuário específico, sendo assim para o cidadão ou para o gestor. Ambos têm acesso aos medicamentos que estão registrados na aplicação, conforme evidenciado na ~\refFig{arquitetura01}.

\figuraBib{arquitetura01}{Sistema de software decomposto em componentes}{}{arquitetura01}{width=.60\textwidth}%

\figuraBib{arquitetura_2}{Sistema de software segundo uma visão de subsistemas}{}{arquitetura_2}{width=.60\textwidth}%

Analisando a arquitetura seguindo uma visão \emph{(view)} de subsistemas, tem-se que o sistema é composto por três subsistemas, sendo eles, o subsistema de autenticação, usuário e medicamentos. O subsistema de autenticação tem como objetivo realizar a identificação de qual usuário está realizando acesso ao sistema através da autenticação.  

O subsistema seguinte é o de usuário, esse subsistema tem uma responsabilidade sequencial referente ao subsistema de autenticação. Pois, caso o usuário autenticado seja o cidadão, ele tem funcionalidades especificas para esse usuário. Enquanto caso o usuário autenticado seja o gestor do posto de saúde, as funcionalidades disponibilizadas são distintas das funcionalidades que são liberadas em relação as funcionalidades para o usuário cidadão.
Por fim, o subsistema de medicamentos é responsável pelo acesso aos medicamentos que serão registrados no sistema. De acordo com o usuário o subsistema de medicamentos tem funcionalidades distintas, como exemplo, para o gestor do posto de saúde o subsistema de medicamentos possui como funcionalidade o controle do estoque de medicamentos, sendo possível cadastrar, atualizar , excluir e visualizar os medicamentos. Enquanto para o cidadão o subsistema medicamentos possuir como funcionalidade visualizar a lista de medicamentos disponibilizados. 
 Sendo assim, pode ser observado na ~\refFig{arquitetura_2} que o sistema é composto por três subsistemas, cada um contendo a suas respectivas responsabilidades para o sistema de software deste projeto.
...
\figuraBib{diagramabd}{Modelo relacional desenvolvido para o projeto}{}{diagramabd}{width=.99\textwidth}%
