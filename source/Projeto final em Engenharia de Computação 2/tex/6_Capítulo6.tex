...
Os cenários de caso de uso tem como objetivo capturar o comportamento do sistema para produriz um resultado que seja de fácil observação para os usuários que devem interagir com o sistema.
