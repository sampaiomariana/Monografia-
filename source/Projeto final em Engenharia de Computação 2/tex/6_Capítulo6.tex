...
Para realizar o desenvolvimento do sistema de software foi utilizada uma liguagem de programação que é amplamente utilizada, sendo ela realizada em PHP. Justamente com PHP foi utilizada a \acrfull{HTML}, JavaScript e \acrfull{CSS} para desenvolver o \emph{frontend} do sistema de software. O desenvolvimento do sistema de software foi realizado utilizando o editor de texto Visual Studio Code.
...
Ao inicar o XAMPP são iniciados os serviços do Apache e do MySQL. Tendo esses seviços iniciados para acessar o sistema de software desenvolvido ele é acessado por meio do endereço http://localhost:8080/GSUS. O navegador web utilizado para realizar a navegação no sistema de software foi o Google Chrome.
