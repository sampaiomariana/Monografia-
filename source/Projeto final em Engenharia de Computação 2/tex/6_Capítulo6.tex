...
Na fase de elaboração foram executadas atividades descritas no \acrfull{OpenUp}. Seguindo dessa forma o ciclo de vida do projeto. O fluxo de trabalho que é proposto pelo \acrfull{OpenUp} pode ser observado na ~\refFig{elaboracao}.

\figuraBib{elaboracao}{Fluxo de trabalho proposto pelo OpenUp para fase de elaboração.}{openup}{elaboracao}{width=.70\textwidth}%
...
O artefato de plano de projeto foi desenvolvido inicialmente na fase de iniciação do projeto, conforme apresentado na ~\refFig{iniciarprojeto}. Já o artefato de plano de iteração foi desenvolvido na fase de planejar e gerenciar a iteração conforme apresentado na ~\refFig{plniteracao}.
\section{Arquitetura}
