...
Analisando a arquitetura seguindo uma visão \emph{(view)} de subsistemas, tem-se que o subsistema de autenticação. Esse subsistema tem como objetivo permitir que o usuário ao logar no sistema tenha acesso ao sistema que é disponibilizado de acordo com a sua permissão de acesso. O subsistema seguinte é referente ao usuário, isso ocorre pois, caso o usuário autenticado seja o cidadão, ele tem funcionalidades como acesso a lista de medicamentos disponibilizadas. Enquanto caso o usuário autenticado seja o gestor do posto de saúde, as funcionalidades disponibilizadas são distintas, como exemplo, a funcionalidade de controle de estoque. Por fim, o subsistema de medicamentos é responsável pelo acesso aos medicamentos que serão registrados no sistema. Sendo assim, pode ser observado na ~\refFig{arquitetura_2} que o sistema é composto por três subsistemas, cada um contendo a suas respectivas responsabilidades para o sistema de software deste projeto.
...
\figuraBib{diagramabd}{Modelo relacional desenvolvido para o projeto}{}{diagramabd}{width=.82\textwidth}%
